...
public class Solutions extends javax.swing.JFrame implements Runnable {
    ...
    public Solutions(int[][] sol, int num0fthread) {
        initComponents();
        no = 1;
        this.sol = sol;
        num0fkey = Master.key0fSolve;
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/makeasquare/exit.png"))); // NOI18N
